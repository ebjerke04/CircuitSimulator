...
VoltageSource_DC::VoltageSource_DC(const ImVec2& gridPosition, Circuit& circuit) : Component(gridPosition, circuit)
{
	std::string name = circuit.findAvailableName<VoltageSource_DC>();
	setName(name);
